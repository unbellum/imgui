...
void ImGui::TextEx(ImStr text, ImGuiTextFlags flags)
{
...
void ImGui::TextUnformatted(ImStr text)
{
...
void ImGui::TextV(const char* fmt, va_list args)
{
    ...
    TextEx(ImStr(g.TempBuffer, text_end), ImGuiTextFlags_NoWidthForLargeClippedText);
}
...
void ImGui::LabelTextV(ImStr label, const char* fmt, va_list args)
{
    ...
    RenderTextClipped(value_bb.Min, value_bb.Max, ImStr(value_text_begin, value_text_end), NULL, ImVec2(0.0f, 0.5f));
...
void ImGui::BulletTextV(const char* fmt, va_list args)
{
    ...
    RenderText(bb.Min + ImVec2(g.FontSize + style.FramePadding.x * 2, 0.0f), ImStr(text_begin, text_end), false);
}
...
bool ImGui::ButtonEx(ImStr label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
bool ImGui::Button(ImStr label, const ImVec2& size_arg)
{
    return ButtonEx(label, size_arg, ImGuiButtonFlags_None);
}

// Small buttons fits within text without additional vertical spacing.
bool ImGui::SmallButton(ImStr label)
{
    ImGuiContext& g = *GImGui;
...
bool ImGui::InvisibleButton(ImStr str_id, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
bool ImGui::ArrowButtonEx(ImStr str_id, ImGuiDir dir, ImVec2 size, ImGuiButtonFlags flags)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
bool ImGui::ArrowButton(ImStr str_id, ImGuiDir dir)
{
...
bool ImGui::Checkbox(ImStr label, bool* v)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
template<typename T>
bool ImGui::CheckboxFlagsT(ImStr label, T* flags, T flags_value)
{
...
bool ImGui::CheckboxFlags(ImStr label, int* flags, int flags_value)
{
    return CheckboxFlagsT(label, flags, flags_value);
}

bool ImGui::CheckboxFlags(ImStr label, unsigned int* flags, unsigned int flags_value)
{
    return CheckboxFlagsT(label, flags, flags_value);
}

bool ImGui::CheckboxFlags(ImStr label, ImS64* flags, ImS64 flags_value)
{
    return CheckboxFlagsT(label, flags, flags_value);
}

bool ImGui::CheckboxFlags(ImStr label, ImU64* flags, ImU64 flags_value)
{
    return CheckboxFlagsT(label, flags, flags_value);
}

bool ImGui::RadioButton(ImStr label, bool active)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
bool ImGui::RadioButton(ImStr label, int* v, int v_button)
{
...
bool ImGui::BeginCombo(ImStr label, ImStr preview_value, ImGuiComboFlags flags)
{
    ...
    if (!preview_value.Empty() && !(flags & ImGuiComboFlags_NoPreview))
        RenderTextClipped(frame_bb.Min + style.FramePadding, ImVec2(value_x2, frame_bb.Max.y), preview_value, NULL, ImVec2(0.0f, 0.0f));
    if (label_size.x > 0)
...
bool ImGui::Combo(ImStr label, int* current_item, bool (*items_getter)(void*, int, const char**), void* data, int items_count, int popup_max_height_in_items)
{
    ImGuiContext& g = *GImGui;
...
bool ImGui::Combo(ImStr label, int* current_item, const char* const items[], int items_count, int height_in_items)
{
...
bool ImGui::Combo(ImStr label, int* current_item, const char* items_separated_by_zeros, int height_in_items)
{
    int items_count = 0;
...
bool ImGui::DragScalar(ImStr label, ImGuiDataType data_type, void* p_data, float v_speed, const void* p_min, const void* p_max, ImStr format_p, ImGuiSliderFlags flags)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
    ...
    else if (data_type == ImGuiDataType_S32 && format_p != ImStr("%d")) // (FIXME-LEGACY: Patch old "%.0f" format string to use "%d", read function more details.)
    ...
    RenderTextClipped(frame_bb.Min, frame_bb.Max, ImStr(value_buf, value_buf_end), NULL, ImVec2(0.5f, 0.5f));
...
bool ImGui::DragScalarN(ImStr label, ImGuiDataType data_type, void* p_data, int components, float v_speed, const void* p_min, const void* p_max, ImStr format, ImGuiSliderFlags flags)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
bool ImGui::DragFloat(ImStr label, float* v, float v_speed, float v_min, float v_max, ImStr format, ImGuiSliderFlags flags)
{
    return DragScalar(label, ImGuiDataType_Float, v, v_speed, &v_min, &v_max, format, flags);
}

bool ImGui::DragFloat2(ImStr label, float v[2], float v_speed, float v_min, float v_max, ImStr format, ImGuiSliderFlags flags)
{
    return DragScalarN(label, ImGuiDataType_Float, v, 2, v_speed, &v_min, &v_max, format, flags);
}

bool ImGui::DragFloat3(ImStr label, float v[3], float v_speed, float v_min, float v_max, ImStr format, ImGuiSliderFlags flags)
{
    return DragScalarN(label, ImGuiDataType_Float, v, 3, v_speed, &v_min, &v_max, format, flags);
}

bool ImGui::DragFloat4(ImStr label, float v[4], float v_speed, float v_min, float v_max, ImStr format, ImGuiSliderFlags flags)
{
    return DragScalarN(label, ImGuiDataType_Float, v, 4, v_speed, &v_min, &v_max, format, flags);
}

// NB: You likely want to specify the ImGuiSliderFlags_AlwaysClamp when using this.
bool ImGui::DragFloatRange2(ImStr label, float* v_current_min, float* v_current_max, float v_speed, float v_min, float v_max, ImStr format, ImStr format_max, ImGuiSliderFlags flags)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
bool ImGui::DragInt(ImStr label, int* v, float v_speed, int v_min, int v_max, ImStr format, ImGuiSliderFlags flags)
{
    return DragScalar(label, ImGuiDataType_S32, v, v_speed, &v_min, &v_max, format, flags);
}

bool ImGui::DragInt2(ImStr label, int v[2], float v_speed, int v_min, int v_max, ImStr format, ImGuiSliderFlags flags)
{
    return DragScalarN(label, ImGuiDataType_S32, v, 2, v_speed, &v_min, &v_max, format, flags);
}

bool ImGui::DragInt3(ImStr label, int v[3], float v_speed, int v_min, int v_max, ImStr format, ImGuiSliderFlags flags)
{
    return DragScalarN(label, ImGuiDataType_S32, v, 3, v_speed, &v_min, &v_max, format, flags);
}

bool ImGui::DragInt4(ImStr label, int v[4], float v_speed, int v_min, int v_max, ImStr format, ImGuiSliderFlags flags)
{
    return DragScalarN(label, ImGuiDataType_S32, v, 4, v_speed, &v_min, &v_max, format, flags);
}

// NB: You likely want to specify the ImGuiSliderFlags_AlwaysClamp when using this.
bool ImGui::DragIntRange2(ImStr label, int* v_current_min, int* v_current_max, float v_speed, int v_min, int v_max, ImStr format, ImStr format_max, ImGuiSliderFlags flags)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
bool ImGui::DragScalar(ImStr label, ImGuiDataType data_type, void* p_data, float v_speed, const void* p_min, const void* p_max, ImStr format, float power)
{
...
bool ImGui::DragScalarN(ImStr label, ImGuiDataType data_type, void* p_data, int components, float v_speed, const void* p_min, const void* p_max, ImStr format, float power)
{
    ImGuiSliderFlags drag_flags = ImGuiSliderFlags_None;
    if (power != 1.0f)
    {
...
bool ImGui::SliderScalar(ImStr label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, ImStr format_p, ImGuiSliderFlags flags)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
    ...
    {
        ImStrncpy(format_0, format_p, IM_ARRAYSIZE(format_0));
        if (data_type == ImGuiDataType_S32 && format_p != ImStr("%d")) // (FIXME-LEGACY: Patch old "%.0f" format string to use "%d", read function more details.)
            format = PatchFormatStringFloatToInt(format);
    }
...
bool ImGui::SliderScalarN(ImStr label, ImGuiDataType data_type, void* v, int components, const void* v_min, const void* v_max, ImStr format, ImGuiSliderFlags flags)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
bool ImGui::SliderFloat(ImStr label, float* v, float v_min, float v_max, ImStr format, ImGuiSliderFlags flags)
{
    return SliderScalar(label, ImGuiDataType_Float, v, &v_min, &v_max, format, flags);
}

bool ImGui::SliderFloat2(ImStr label, float v[2], float v_min, float v_max, ImStr format, ImGuiSliderFlags flags)
{
    return SliderScalarN(label, ImGuiDataType_Float, v, 2, &v_min, &v_max, format, flags);
}

bool ImGui::SliderFloat3(ImStr label, float v[3], float v_min, float v_max, ImStr format, ImGuiSliderFlags flags)
{
    return SliderScalarN(label, ImGuiDataType_Float, v, 3, &v_min, &v_max, format, flags);
}

bool ImGui::SliderFloat4(ImStr label, float v[4], float v_min, float v_max, ImStr format, ImGuiSliderFlags flags)
{
    return SliderScalarN(label, ImGuiDataType_Float, v, 4, &v_min, &v_max, format, flags);
}

bool ImGui::SliderAngle(ImStr label, float* v_rad, float v_degrees_min, float v_degrees_max, ImStr format, ImGuiSliderFlags flags)
{
    if (format.Empty())
        format = "%.0f deg";
...
bool ImGui::SliderInt(ImStr label, int* v, int v_min, int v_max, ImStr format, ImGuiSliderFlags flags)
{
    return SliderScalar(label, ImGuiDataType_S32, v, &v_min, &v_max, format, flags);
}

bool ImGui::SliderInt2(ImStr label, int v[2], int v_min, int v_max, ImStr format, ImGuiSliderFlags flags)
{
    return SliderScalarN(label, ImGuiDataType_S32, v, 2, &v_min, &v_max, format, flags);
}

bool ImGui::SliderInt3(ImStr label, int v[3], int v_min, int v_max, ImStr format, ImGuiSliderFlags flags)
{
    return SliderScalarN(label, ImGuiDataType_S32, v, 3, &v_min, &v_max, format, flags);
}

bool ImGui::SliderInt4(ImStr label, int v[4], int v_min, int v_max, ImStr format, ImGuiSliderFlags flags)
{
    return SliderScalarN(label, ImGuiDataType_S32, v, 4, &v_min, &v_max, format, flags);
}

bool ImGui::VSliderScalar(ImStr label, const ImVec2& size, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, ImStr format_p, ImGuiSliderFlags flags)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
    ...
    char value_buf[64];
    const char* value_buf_end = value_buf + DataTypeFormatString(value_buf, IM_ARRAYSIZE(value_buf), data_type, p_data, format);
    RenderTextClipped(ImVec2(frame_bb.Min.x, frame_bb.Min.y + style.FramePadding.y), frame_bb.Max, ImStr(value_buf, value_buf_end), NULL, ImVec2(0.5f, 0.0f));
    if (label_size.x > 0.0f)
        RenderText(ImVec2(frame_bb.Max.x + style.ItemInnerSpacing.x, frame_bb.Min.y + style.FramePadding.y), label);
...
bool ImGui::VSliderFloat(ImStr label, const ImVec2& size, float* v, float v_min, float v_max, ImStr format, ImGuiSliderFlags flags)
{
    return VSliderScalar(label, size, ImGuiDataType_Float, v, &v_min, &v_max, format, flags);
}

bool ImGui::VSliderInt(ImStr label, const ImVec2& size, int* v, int v_min, int v_max, ImStr format, ImGuiSliderFlags flags)
{
...
// Obsolete versions with power parameter. See https://github.com/ocornut/imgui/issues/3361 for details.
bool ImGui::SliderScalar(ImStr label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, ImStr format, float power)
{
...
bool ImGui::SliderScalarN(ImStr label, ImGuiDataType data_type, void* v, int components, const void* v_min, const void* v_max, ImStr format, float power)
{
    ImGuiSliderFlags slider_flags = ImGuiSliderFlags_None;
    if (power != 1.0f)
    {
...
bool ImGui::TempInputText(const ImRect& bb, ImGuiID id, ImStr label, char* buf, int buf_size, ImGuiInputTextFlags flags)
{
...
bool ImGui::TempInputScalar(const ImRect& bb, ImGuiID id, ImStr label, ImGuiDataType data_type, void* p_data, const char* format, const void* p_clamp_min, const void* p_clamp_max)
{
    ImGuiContext& g = *GImGui;
...
bool ImGui::InputScalar(ImStr label, ImGuiDataType data_type, void* p_data, const void* p_step, const void* p_step_fast, ImStr format_p, ImGuiInputTextFlags flags)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
bool ImGui::InputScalarN(ImStr label, ImGuiDataType data_type, void* p_data, int components, const void* p_step, const void* p_step_fast, ImStr format, ImGuiInputTextFlags flags)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
bool ImGui::InputFloat(ImStr label, float* v, float step, float step_fast, ImStr format, ImGuiInputTextFlags flags)
{
    flags |= ImGuiInputTextFlags_CharsScientific;
    return InputScalar(label, ImGuiDataType_Float, (void*)v, (void*)(step > 0.0f ? &step : NULL), (void*)(step_fast > 0.0f ? &step_fast : NULL), format, flags);
}

bool ImGui::InputFloat2(ImStr label, float v[2], ImStr format, ImGuiInputTextFlags flags)
{
    return InputScalarN(label, ImGuiDataType_Float, v, 2, NULL, NULL, format, flags);
}

bool ImGui::InputFloat3(ImStr label, float v[3], ImStr format, ImGuiInputTextFlags flags)
{
    return InputScalarN(label, ImGuiDataType_Float, v, 3, NULL, NULL, format, flags);
}

bool ImGui::InputFloat4(ImStr label, float v[4], ImStr format, ImGuiInputTextFlags flags)
{
    return InputScalarN(label, ImGuiDataType_Float, v, 4, NULL, NULL, format, flags);
}

bool ImGui::InputInt(ImStr label, int* v, int step, int step_fast, ImGuiInputTextFlags flags)
{
...
bool ImGui::InputInt2(ImStr label, int v[2], ImGuiInputTextFlags flags)
{
    return InputScalarN(label, ImGuiDataType_S32, v, 2, NULL, NULL, "%d", flags);
}

bool ImGui::InputInt3(ImStr label, int v[3], ImGuiInputTextFlags flags)
{
    return InputScalarN(label, ImGuiDataType_S32, v, 3, NULL, NULL, "%d", flags);
}

bool ImGui::InputInt4(ImStr label, int v[4], ImGuiInputTextFlags flags)
{
    return InputScalarN(label, ImGuiDataType_S32, v, 4, NULL, NULL, "%d", flags);
}

bool ImGui::InputDouble(ImStr label, double* v, double step, double step_fast, ImStr format, ImGuiInputTextFlags flags)
{
    flags |= ImGuiInputTextFlags_CharsScientific;
...
bool ImGui::InputText(ImStr label, char* buf, size_t buf_size, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* user_data)
{
    IM_ASSERT(!(flags & ImGuiInputTextFlags_Multiline)); // call InputTextMultiline()
    return InputTextEx(label, NULL, buf, (int)buf_size, ImVec2(0, 0), flags, callback, user_data);
}

bool ImGui::InputTextMultiline(ImStr label, char* buf, size_t buf_size, const ImVec2& size, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* user_data)
{
    return InputTextEx(label, NULL, buf, (int)buf_size, size, flags | ImGuiInputTextFlags_Multiline, callback, user_data);
}

bool ImGui::InputTextWithHint(ImStr label, ImStr hint, char* buf, size_t buf_size, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* user_data)
{
    IM_ASSERT(!(flags & ImGuiInputTextFlags_Multiline)); // call InputTextMultiline()
...
void ImGuiInputTextCallbackData::InsertChars(int pos, ImStr new_text)
{
...
bool ImGui::InputTextEx(ImStr label, ImStr hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
    ...
    if (render_cursor || render_selection)
    {
        ...
        if (is_multiline || (buf_display_end - buf_display) < buf_display_max_length)
        {
            ...
            draw_window->DrawList->AddText(g.Font, g.FontSize, draw_pos - draw_scroll, col, ImStr(buf_display, buf_display_end), 0.0f, is_multiline ? NULL : &clip_rect);
        }
    ...
    else
    {
        ...
        {
            ImU32 col = GetColorU32(is_displaying_hint ? ImGuiCol_TextDisabled : ImGuiCol_Text);
            draw_window->DrawList->AddText(g.Font, g.FontSize, draw_pos, col, ImStr(buf_display, buf_display_end), 0.0f, is_multiline ? NULL : &clip_rect);
        }
    }
    ...
    if (g.LogEnabled && (!is_password || is_displaying_hint))
        LogRenderedText(&draw_pos, ImStr(buf_display, buf_display_end));
...
bool ImGui::ColorEdit3(ImStr label, float col[3], ImGuiColorEditFlags flags)
{
...
bool ImGui::ColorEdit4(ImStr label, float col[4], ImGuiColorEditFlags flags)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
bool ImGui::ColorPicker3(ImStr label, float col[3], ImGuiColorEditFlags flags)
{
...
bool ImGui::ColorPicker4(ImStr label, float col[4], ImGuiColorEditFlags flags, const float* ref_col)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
...
bool ImGui::ColorButton(ImStr desc_id, const ImVec4& col, ImGuiColorEditFlags flags, ImVec2 size)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
void ImGui::ColorTooltip(ImStr text, const float* col, ImGuiColorEditFlags flags)
{
    ImGuiContext& g = *GImGui;
...
bool ImGui::TreeNode(ImStr label)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
bool ImGui::TreeNodeEx(ImStr label, ImGuiTreeNodeFlags flags)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
bool ImGui::TreeNodeEx(ImStr str_id, ImGuiTreeNodeFlags flags, const char* fmt, ...)
{
    va_list args;
    va_start(args, fmt);
...
bool ImGui::TreeNodeExV(ImStr str_id, ImGuiTreeNodeFlags flags, const char* fmt, va_list args)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
    ...
    return TreeNodeBehavior(window->GetID(str_id), flags, ImStr(g.TempBuffer, label_end));
}
...
bool ImGui::TreeNodeExV(const void* ptr_id, ImGuiTreeNodeFlags flags, const char* fmt, va_list args)
{
    ...
    ImGuiContext& g = *GImGui;
    const char* label_end = g.TempBuffer + ImFormatStringV(g.TempBuffer, IM_ARRAYSIZE(g.TempBuffer), fmt, args);
    return TreeNodeBehavior(window->GetID(ptr_id), flags, ImStr(g.TempBuffer, label_end));
}
...
bool ImGui::TreeNodeBehavior(ImGuiID id, ImGuiTreeNodeFlags flags, ImStr label)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
    ...
    if (display_frame)
    {
        ...
        if (g.LogEnabled)
        {
            ...
            LogRenderedText(&text_pos, ImStr(log_prefix, log_prefix + 3));
            RenderTextClipped(text_pos, frame_bb.Max, label, &label_size);
            LogRenderedText(&text_pos, ImStr(log_suffix, log_suffix + 2));
        }
        else
        {
            RenderTextClipped(text_pos, frame_bb.Max, label, &label_size);
...
void ImGui::TreePush(ImStr str_id)
{
    ImGuiWindow* window = GetCurrentWindow();
    Indent();
    window->DC.TreeDepth++;
...
bool ImGui::CollapsingHeader(ImStr label, ImGuiTreeNodeFlags flags)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
bool ImGui::CollapsingHeader(ImStr label, bool* p_open, ImGuiTreeNodeFlags flags)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
bool ImGui::Selectable(ImStr label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
bool ImGui::Selectable(ImStr label, bool* p_selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
...
bool ImGui::ListBoxHeader(ImStr label, const ImVec2& size_arg)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
...
bool ImGui::ListBoxHeader(ImStr label, int items_count, int height_in_items)
{
...
bool ImGui::ListBox(ImStr label, int* current_item, const char* const items[], int items_count, int height_items)
{
...
int ImGui::PlotEx(ImGuiPlotType plot_type, ImStr label, float (*values_getter)(void* data, int idx), void* data, int values_count, int values_offset, ImStr overlay_text, float scale_min, float scale_max, ImVec2 frame_size)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
...
bool ImGui::BeginMenu(ImStr label, bool enabled)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
bool ImGui::MenuItem(ImStr label, ImStr shortcut, bool selected, bool enabled)
{
    ...
    else
    {
        ...
        {
            PushStyleColor(ImGuiCol_Text, g.Style.Colors[ImGuiCol_TextDisabled]);
            RenderText(pos + ImVec2(window->DC.MenuColumns.Pos[1] + extra_w, 0.0f), shortcut, false);
            PopStyleColor();
        }
        if (selected)
...
namespace ImGui
{
    ...
    static ImU32            TabBarCalcTabID(ImGuiTabBar* tab_bar, ImStr label);
...
bool    ImGui::BeginTabBar(ImStr str_id, ImGuiTabBarFlags flags)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = g.CurrentWindow;
    if (window->SkipItems)
...
static ImU32   ImGui::TabBarCalcTabID(ImGuiTabBar* tab_bar, ImStr label)
{
...
bool    ImGui::BeginTabItem(ImStr label, bool* p_open, ImGuiTabItemFlags flags)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = g.CurrentWindow;
    if (window->SkipItems)
...
bool    ImGui::TabItemButton(ImStr label, ImGuiTabItemFlags flags)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = g.CurrentWindow;
    if (window->SkipItems)
...
bool    ImGui::TabItemEx(ImGuiTabBar* tab_bar, ImStr label, bool* p_open, ImGuiTabItemFlags flags)
{
...
void    ImGui::SetTabItemClosed(ImStr label)
{
    ImGuiContext& g = *GImGui;
...
ImVec2 ImGui::TabItemCalcSize(ImStr label, bool has_close_button)
{
    ImGuiContext& g = *GImGui;
    ImVec2 label_size = CalcTextSize(label, true);
...
void ImGui::TabItemLabelAndCloseButton(ImDrawList* draw_list, const ImRect& bb, ImGuiTabItemFlags flags, ImVec2 frame_padding, ImStr label, ImGuiID tab_id, ImGuiID close_button_id, bool is_contents_visible, bool* out_just_closed, bool* out_text_clipped)
{
    ...
    {
        text_pixel_clip_bb.Max.x -= CalcTextSize(ImStr(TAB_UNSAVED_MARKER), false).x;
        ...
        RenderTextClippedEx(draw_list, unsaved_marker_pos, bb.Max - frame_padding, TAB_UNSAVED_MARKER, NULL);
    }
